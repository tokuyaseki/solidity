...
- ``address``, ``address payable``: equivalent to ``uint160``, except for the assumed interpretation and language typing. For computing the function selector, ``address`` is used.
...
- ``address payable``: as in the ``address`` case
