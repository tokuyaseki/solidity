...
contract token is safeMath, module, announcementTypes {
    ...
    */
    ...
    constructor(bool forReplace, address payable moduleHandler, address dbAddr, address payable icoContractAddr, address payable exchangeContractAddress, address[] memory genesisAddr, uint256[] memory genesisValue) public payable {
        /*
